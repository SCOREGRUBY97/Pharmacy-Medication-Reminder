    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div
        style={{
          ...
          top: 0,
          bottom: 0,
          left: mobile ? (sidebarOpen ? 0 : -270) : 0,
          zIndex: 100,
          boxShadow: '2px 0 12px rgba(0,0,0,0.2)',
          transition: 'left 0.25s ease',
        }}
      >
        <div style={{ padding: mobile ? '58px 14px 12px' : '16px 14px 12px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 9, marginBottom: 14 }}>
            <div style={{ width: 32, height: 32, background: acc, borderRadius: 9, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 15, flexShrink: 0 }}>
              💊
            </div>
            <div>
              <div style={{ color: '#fff', fontWeight: 700, fontSize: 14, fontFamily: 'Plus Jakarta Sans, Inter, sans-serif' }}>
                MediCare PRO
              </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 10px', background: 'rgba(255,255,255,0.07)', borderRadius: 8 }}>
            <div style={{ width: 26, height: 26, borderRadius: '50%', background: acc, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: 10, fontWeight: 600, flexShrink: 0 }}>
              {initials}
            </div>
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{ color: 'rgba(255,255,255,0.38)', fontSize: 9, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {email}
              </div>
            </div>
          </div>
        ...
        <nav style={{ padding: '10px 10px', flex: 1, overflowY: 'auto' }}>
          <div style={{ color: 'rgba(255,255,255,0.28)', fontSize: 9, fontWeight: 600, letterSpacing: 1.2, padding: '4px 2px 8px', textTransform: 'uppercase' }}>
            Navigation
          </div>
          ...
          {navList.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.badge > 0 && (
                  <span style={{ background: '#DC2626', color: '#fff', fontSize: 9, fontWeight: 700, padding: '1px 5px', borderRadius: 20 }}>
                    {item.badge}
                  </span>
                )}
              </div>
        ...
        <div style={{ padding: '10px 12px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div style={{ color: 'rgba(255,255,255,0.18)', fontSize: 10, marginTop: 6, textAlign: 'center' }}>
            MediCare PRO v2.0
          </div>
        </div>
      </div>

...
-- ================================================================
-- ADD REAL ADMIN ACCOUNT
-- gaurabbhusal7@gmail.com / 12345678
-- ================================================================
-- First remove old seed admin if exists
DELETE FROM users WHERE email = 'gaurabbhusal7@gmail.com';

-- Insert real admin (password: 12345678)
INSERT INTO users (full_name, email, password_hash, role, is_verified, notify_email)

...
router.post('/caregiver/alert-patient', authenticate, caregiverUp, cg.alertPatient);
router.delete('/caregiver/link/:patient_id', authenticate, caregiverUp, cg.unlinkPatient);

// ─── PATIENT CAREGIVER LINKING ───────────────────────────────
router.get('/patient/caregivers', authenticate, patientOnly, cg.getCaregiversForPatient);
router.post('/patient/link-caregiver', authenticate, patientOnly, cg.linkCaregiverByEmail);
router.delete('/patient/link-caregiver/:caregiver_id', authenticate, patientOnly, cg.unlinkCaregiver);

...
export const reminderEmail = (patientName, medications) => ({
...
export const missedDoseAlert = (caregiverName, patientName, medName, time) => ({
...
export const lowStockAlert = (patientName, medName, daysLeft) => ({
...
export const weeklyReportEmail = (name, stats) => ({
...
export const streakEmail = (name, days) => ({
